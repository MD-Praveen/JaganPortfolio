...
const About = () => {
    ...
    const visionaryImage = "https://cdn.sanity.io/images/soweeiig/production/ba733a6ba601770990755990c72b052a62f57cbc-626x626.jpg";

  return (
    <div className={styles.aboutContainer}>
        <p className={styles.title}>
            <h3>I know that <span>Good Design</span></h3>
            <h3>means <span>Good Business</span></h3>
        </p>
        ...
        <div className={styles.intrests}>
                <div className={styles.card}>
                    <div className={styles.cardImage}><img src={developerImg} alt="developer" /></div>
                    <div className={styles.cardDiscription}>
                        <h3>Fullstack Developer</h3>
                        <p>MERN stack, well skilled with React, Node.js, MongoDB, RESTful APIs etc..</p>
                    </div>
                </div>

                <div className={styles.card}>
                    <div className={styles.cardImage}><img src={problemsolverImg} alt="developer" /></div>
                    <div className={styles.cardDiscription}>
                ...
                <div className={styles.card}>
                    <div className={styles.cardImage}><img src={visionaryImage} alt="developer" /></div>
                    <div className={styles.cardDiscription}>
                        <h3>Visionary</h3>
                        <p>
